  ...
  <b-navbar class="border-top bg-light py-0">
    ...
    >
      ...
      >
        ...
        <div class="text-size">サインアウト</div>
      </b-button>
    </div>
  </b-navbar>
</template>
